...
public class QuaternaryController {
    ...
    private NaturalPerson newPerson;
    ...
    public void initialize() {
        newPerson = new NaturalPerson(new String[]{"N", "", ""});
        setupContainers();
    }
    ...
    @FXML
    private void addSocialMediaHanldeClick(ActionEvent event) {
        showInputDialog("Add Social Media", new String[]{"Platform", "Username"},
            result -> {
                if (result != null) {
                    ...
                    newPerson.getSocialMediaAccounts().add(social);
    ...
    @FXML
    private void addImportantDatesHanldeClick(ActionEvent event) {
        showInputDialog("Add Important Date", new String[]{"Event", "Date"},
            result -> {
                if (result != null) {
                    ...
                    newPerson.getImportantDates().add(date);
    ...
    @FXML
    private void exitHandleClick(ActionEvent event) {
        try {
            // Assuming you have firstNameField and lastNameField in your FXML
            newPerson.setFirstName(firstNameField.getText());
            newPerson.setSurname(lastNameField.getText());

            Contact currentUser = (Contact) DataHolder.getInstance().getMyData();
            currentUser.getRelatedContacts().add(newPerson);
            
            InformationManage.saveContactData(contactsDirectory, currentUser.getUser(), currentUser);
            InformationManage.saveContactData(contactsDirectory, newPerson.getUser(), newPerson);
